...
import product1 from "../../Assets/Cinemomen3.jpg";
import product2 from "../../Assets/Cinemomen2.jpg";
import product3 from "../../Assets/Cinemomen1.jpg";
import product4 from "../../Assets/Cinemomen.jpg";
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', height: "90%", flexDirection: 'column', alignItems: 'center', marginBottom:{xs:"-600px", sm:"-500px" ,md:"-100px"} }}>
            <Box sx={{ width: { mx: "100%", md: '80%' }, marginTop: '2%', display: 'flex', justifyContent: { xs: "center", md: 'space-between' }, flexDirection: { xs: 'column', sm: 'column', md: 'row' }, alignItems: 'center' }}>
                ...
                <Box sx={{ width: { xs: "90%", md: '45%' }, height: { xs: "650px", md: '700px' }, marginTop: "-200px" }}>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', marginBottom:"20px"}}>Cinnamon</Typography>
                    <Typography variant="p" sx={{ fontSize:"20px", display:"block", textAlign:"justify" }}>Sri Lankan cinnamon, also known as Ceylon cinnamon, is renowned for its delicate flavor and health benefits. Unlike the more common cassia cinnamon, Ceylon cinnamon has a sweet, mild taste and is often referred to as "true cinnamon." It is highly prized for its antioxidant properties and is used in both culinary dishes and traditional medicine. Sri Lanka is one of the largest producers of this premium spice, which is harvested from the inner bark of the Cinnamomum verum tree.</Typography>
