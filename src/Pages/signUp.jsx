...
export default function SignUp() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            navigate("/signIn"); // Navigate after successful login
        ...
        <Box sx={{backgroundImage:"linear-gradient(to bottom, #D1E9F6, #F5EDED)", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center"}}>
            <Box sx={{width:"60%", height:"70%", backgroundColor:"white", borderRadius:"40px", boxShadow:"0px 0px 10px 0px rgba(0,0,0,0.2)", display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"row"}}>
                <Box sx={{width:"50%", height:"100%", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
                    <Typography sx={{fontSize:"45px", fontWeight:"bold"}}>Create Account</Typography>
                    <Box>
                    ...
                    <TextField onChange={(e) => setName(e.target.value)} sx={{width:"70%", marginTop:"20px"}} id="outlined-basic" label="Name" variant="outlined" />
                    <TextField onChange={(e) => setEmail(e.target.value)} sx={{width:"70%", marginTop:"20px"}} id="outlined-basic" label="Email" variant="outlined" />
                    <TextField onChange={(e) => setPassword(e.target.value)} sx={{width:"70%", marginTop:"20px"}} id="outlined-password-input" type="password" label="Password" variant="outlined" />
                    <Button onClick={handleSubmit} size="large" sx={{color:"white", backgroundColor:"#F0A500", marginTop:'40px', width:"40%",  fontSize:"18px", textAlign:"center", alignItems:'center', display:"flex", justifyContent:"center", flexDirection:"column", fontWeight:"bold", "&:hover":{backgroundColor:"#C07F00", color:"white", boxShadow:"none"}}}>Sign Up</Button>
                </Box>
                <Box sx={{backgroundColor:"#201E43", width:"50%", height:"100%", borderRadius:"200px 40px 40px 200px", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
                    <Typography sx={{color:"white", fontSize:"45px", fontWeight:"bold", textAlign:"center", alignItems:'center', display:"flex", justifyContent:"center", flexDirection:"column"}}>Welcome Friend To</Typography>
                    <Avatar src={image1} sx={{ height: "250px", borderRadius: "0px", objectFit: "cover", width: "300px" }}></Avatar>
                    <Typography sx={{color:"white", width:"80%",  fontSize:"22px", textAlign:"center", alignItems:'center', display:"flex", justifyContent:"center", flexDirection:"column"}}>Enter your personal details to access the site features</Typography>
                    <Button onClick={() => navigate('/signIn')} size="large" sx={{color:"white", backgroundColor:"transparent", border:"1px solid white", marginTop:'40px', width:"40%",  fontSize:"18px", textAlign:"center", alignItems:'center', display:"flex", justifyContent:"center", flexDirection:"column", "&:hover":{backgroundColor:"transparent", color:"white", boxShadow:"none" }}}>Sign In</Button>
                </Box>
